...
<body>
    ...
    <script type="text/javascript">
        const PGtitle = 'l7.html'
        const CSVFile = 'loto7.csv';
        const LMax3743 = 37;
        const LSize76 = 7;
        const LBsize79 = 9;
        const TAGLine = '---------------------------------------';
        ...
        function F_read_ajax(str) {
            ...
            do {
                ...
                tr_place[15].innerText = fns2(temp, 0, 0);
                temp.pop();
                temp.pop();
        ...
        function fns2(tx, set3 = 20, view = 1) {
            // テーブルのアレと比較
            let debug = true;
            const TAG = 'log_fns2->';
        ...
        function fns(arrayValt, set1 = 0, set2 = 0, set3 = 10, set5 = 0) {
            ...
            if (arrayVal.length === 0) {
                ...
                fnsw.innerText = arrayVal.sort((a, b) => a - b);
            }
                ...
                do {
                    switch (algorithm) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            // 2021/02/16 50回の数字を参照
                            let temp = G_base_numsY[bnum.length].concat();
                            temp.reverse();
                        ...
                        case 5:
                            // 2021/11/29 可能な数字を指定
                            // nums = [5, 11, 13, 15, 18, 19, 25, 26, 27, 28, 29, 30, 32, 33, 36];  //449
                            // nums = [1,2,5,8,9,15,16,21,26,27,32,33,35,37]; //453
                            G_basenums = nums.concat();
                            break;
                    }
        ...
        function T_ncont2(arrayVal = []) {
            ...
            for (let i = 1; i <= LMax3743; i++) {
                ...
                var b = '';
                for (let t2 = 1; t2 < table[i][1] - 60; t2++) {
                    b = b + '>';
                }
                console.info(i, '60+' + b);
            }
        ...
        function T_show_topNums() {
            ...
            console.info(TAG, TAGLine);
            for (let i = 0; i < 19; i++) {
                tbrs[i + 19].innerText = topNums[i][0];
            }
            ...
            <table table border="1" cellspacing="0" cellpadding="1" bordercolor="#333333" style="display:''">
                <tbody id="tb6">
                    ...
                    <tr align="right">
                        ...
                        <td class="k+" index="7">+</td>
                        <td class="k+" index="8">+</td>
                        <td>0</td>
                        <td>nx6</td>
                        <td>0</td>
                        <td class="bl">X</td>
            ...
            <table table border="1" cellspacing="0" cellpadding="1" bordercolor="#333333" style="display:''">
                <tbody id="tb1">
                    ...
                    <tr align="right">
                        ...
                        <td class="n setColor">(x7)</td>
                        <td class="n setColor">ボ1</td>
                        <td class="n setColor">ボ2</td>
                        <td>口数</td>
                        <td>選金</td>
                        <td>オバ</td>
                        <td class="bl">BL</td>
